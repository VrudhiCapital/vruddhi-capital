...
//     const { founderName, email, startupName, oneLiner, message } = body;
...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      to: [process.env.CONTACT_EMAIL || "pavanachar0123@gmail.com"],
        ...
        <html>
          ...
          <body>
            <div class="container">
              ...
              <p class="body-text">Hi <span class="highlight">${founderName}</span>,</p>
              <p class="body-text">
