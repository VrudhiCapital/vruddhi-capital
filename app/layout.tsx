...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "investment firm Karnataka",
    "investment firm Udupi",
    "startup funding Karnataka",
    "VC firm Udupi",
    "early stage investment India",
    "pre seed funding India",
    "seed funding Karnataka",
    "mission driven founders India",
    "startup investment Mangalore",
    "investor Karnataka",
    "Vruddhi Capital",
    "startup funding South India",
    "consumer startup investment",
    "platform startup funding",
...
return (
  <html lang="en">
    <head>
      ...
      <Script
        src="https://www.googletagmanager.com/gtag/js?id=G-3EBT2B308M"
